...
| `Individual Essay - Unit 9`                    | `Report`                    | Apply the Cyber Security methods and techniques studied during the module to develop a solution to a business problemInclude two UML diagrams showing aspects of the system and at least two threat modelling techniques used to identify potential cyber threats and how these are to be mitigated. | [View Essay](../Modules/1/Module1Unit9Essay.pdf) 
| `End of Module Assignment - Unit 12`           | `Python Code` | Using Python code, implement at least one solution recommended as part of the proposal submitted in the indivdual essay.         | [View Solution Read Me File](../Modules/1/ReadMe.md), [Strong Password Validator Solution Code](../Modules/1/PasswordValidator.py)
